...
Run from Kaggle repo root:
    ...
    python 2026-09-18_screen_e28_m_family_scale_routed.py
...
Outputs:
    2026-09-18_E28_M_FAMILY_SCREEN.md
    2026-09-18_E28_M_FAMILY_SCREEN.json
"""
...
REPORT = ROOT / "2026-09-18_E28_M_FAMILY_SCREEN.md"
DATA = ROOT / "2026-09-18_E28_M_FAMILY_SCREEN.json"
...
def parent(args):
    if not (BUNDLE / "agent_e28_m_family_scale_routed.py").exists():
        raise SystemExit(
            "Missing E28 agent. Run 2026-09-18_install_e28_m_family_scale_routed.py first."
        )
