...
def room_guard(action, view, step):
    """Sell only enough stock to avoid a material day-close capacity loss.

    After the final route switch, small projected overflows are left to the
    terminal planner; earlier or larger pressure is relieved immediately.
    """
