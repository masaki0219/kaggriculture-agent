...
Run from the Kaggle repository root:
    ...
    python tools/acquisition/collect_m_family_corpus.py

Requires the prior live refresh directory:
    data/replays/2026-09-18/live_population/scout_manifest.json
...
Output:
    data/corpora/2026-09-18/m_family/
...
LIVE = ROOT / "data" / "replays" / "2026-09-18" / "live_population"
MANIFEST = LIVE / "scout_manifest.json"

OUT = ROOT / "data" / "corpora" / "2026-09-18" / "m_family"
REPLAYS = OUT / "replays"
CORPUS_MANIFEST = OUT / "manifest.json"
REPORT = OUT / "README.md"
ZIP_OUT = ROOT / "data" / "corpora" / "2026-09-18" / "m_family.zip"
