...
Place this file directly in the Kaggle repository root and run:
    ...
    python 2026-09-18_refresh_live_leaderboard_population.py
...
Outputs in Kaggle root:
    live_population_2026-09-18/
    2026-09-18_live_population_refresh.zip
