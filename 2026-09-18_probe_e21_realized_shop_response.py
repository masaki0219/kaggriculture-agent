...
Put this file directly in the Kaggle repository root and run:
    ...
    python 2026-09-18_probe_e21_realized_shop_response.py

Default:
    12 seeds x 2 opponents x both seats = 48 fresh games

Outputs in Kaggle root:
    2026-09-18_E21_REALIZED_SHOP_RESPONSE.md
    2026-09-18_E21_REALIZED_SHOP_RESPONSE.json
...
REPORT = ROOT / "2026-09-18_E21_REALIZED_SHOP_RESPONSE.md"
DATA = ROOT / "2026-09-18_E21_REALIZED_SHOP_RESPONSE.json"
