...
Place in Kaggle repo root and run:
    ...
    python 2026-09-18_screen_e23_m_family_v1.py
...
Outputs:
    2026-09-18_E23_M_FAMILY_SCREEN.md
    2026-09-18_E23_M_FAMILY_SCREEN.json
...
REPORT = ROOT / "2026-09-18_E23_M_FAMILY_SCREEN.md"
DATA = ROOT / "2026-09-18_E23_M_FAMILY_SCREEN.json"
...
def parent(args):
    if not (BUNDLE / "agent_e23_m_family_v1.py").exists():
        raise SystemExit(
            "Missing E23 agent. Run 2026-09-18_install_e23_m_family_v1.py first."
        )
