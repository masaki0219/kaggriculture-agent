...
Run from Kaggle repo root:
    ...
    python experiments/e026_m_family_state_based/screen.py
...
Outputs:
    ...
    experiments/e026_m_family_state_based/results.json
"""
...
def parent(args):
    if not (BUNDLE / "agent_e26_m_family_state_based.py").exists():
        raise SystemExit(
            "Missing E26 agent. Run experiments/e026_m_family_state_based/builder.py first."
        )
