...
Place in Kaggle repo root and run:
    ...
    python experiments/e024_m_family_corrected/screen.py
...
Outputs:
    ...
    experiments/e024_m_family_corrected/results.json
"""
...
def parent(args):
    ...
    if not agent_path.exists():
        raise SystemExit(
            "Missing canonical E24 agent: artifacts/bundles/current/agent_e24_m_family_corrected.py"
        )
