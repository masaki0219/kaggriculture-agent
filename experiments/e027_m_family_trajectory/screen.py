...
Run from Kaggle repo root:
    ...
    python experiments/e027_m_family_trajectory/screen.py
...
Outputs:
    ...
    experiments/e027_m_family_trajectory/results.json
"""
...
def parent(args):
    if not (BUNDLE / "agent_e27_m_family_trajectory.py").exists():
        raise SystemExit(
            "Missing E27 agent. Run experiments/e027_m_family_trajectory/builder.py first."
        )
