...
Place this file directly in the Kaggle repository root and run:
    ...
    python 2026-09-18_analyze_frontier_failure_regimes.py

Inputs expected in Kaggle root:
    2026-09-18_CURRENT_FRONTIER_SCREEN.json

Outputs:
    2026-09-18_FRONTIER_FAILURE_REGIMES.md
    2026-09-18_FRONTIER_FAILURE_REGIMES.json
...
SCREEN = ROOT / "2026-09-18_CURRENT_FRONTIER_SCREEN.json"
REPORT = ROOT / "2026-09-18_FRONTIER_FAILURE_REGIMES.md"
DATA = ROOT / "2026-09-18_FRONTIER_FAILURE_REGIMES.json"
