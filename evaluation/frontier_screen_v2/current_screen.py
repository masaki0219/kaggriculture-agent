...
Run from the Kaggle repository root:
    ...
    python evaluation/frontier_screen_v2/current_screen.py
...
----------------------
    evaluation/frontier_screen_v2/current_results.md
...
REPORT = HERE / "current_results.md"
DATA = HERE / "current_results.json"
